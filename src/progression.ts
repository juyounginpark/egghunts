...
export function newProgression():Progression{return {level:1,xp:0,requiredXP:requiredXP(1),hp:PROGRESSION.baseHP,maxHP:PROGRESSION.baseHP,pendingXP:0,seenEggs:[],hatchedPets:[],distanceRecord:0,completedStages:[],healthUnlocked:false,stage:1,firstHitUsed:false,immunity:0,slowRemaining:0,slowMultiplier:1};}
...
export function validateProgression(p:Progression){
  ...
  delete p.traits; // Retired player perks: discard legacy selections without resetting progression.
