import type {Block} from '/artifacts/art-rework/before/region-layout.ts';
import {STAGES,ROAD_WIDTH_SCALE} from '/src/stage-data.ts';
...
export {circularVillageArt as villageArt} from '/src/village-art.ts';
